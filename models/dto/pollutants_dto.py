...
from models.domain import Pollutants
...
class PollutantsDTO:
    ...
    @staticmethod
    def from_dict(data: dict) -> 'PollutantsDTO':
    ...
    @staticmethod
    def from_domain(domain: Pollutants) -> 'PollutantsDTO':
        return PollutantsDTO(
            c6h6_value=domain.c6h6_value,
            co_value=domain.co_value,
            h2s_value=domain.h2s_value,
            ipa_value=domain.ipa_value,
            no2_value=domain.no2_value,
            o3_value=domain.o3_value,
            pm10_value=domain.pm10_value,
            pm2dot5_value=domain.pm2dot5_value,
            so2_value=domain.so2_value
        )